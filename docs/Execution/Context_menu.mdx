...
Вы можете заранее создать несколько файлов с настройками и затем загружать их с помощью экшена [**Запуск программ**](../Project%20Editor/CustomCode/RunningPrograms). Или же через действие [**Работа с файлами**](../Android/Files) динамически создавать файл, а потом сохранять в него все данные и подгружать по необходимости.  
