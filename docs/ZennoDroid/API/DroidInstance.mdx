...
title: DroidInstance API | Документация ZennoDroid | ZennoLab
description: DroidInstance API - раздел официальной документации ZennoDroid от ZennoLab. Подробные инструкции, примеры использования и руководство по настройке
---
...
[**`IDroidActionEmulatorAPI Action`**](./ActionEmulator)  
```csharp
int Clone();
