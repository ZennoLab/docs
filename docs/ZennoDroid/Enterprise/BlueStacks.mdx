...
**4.** Скачайте [**данный архив**](./assets/BlueStacks/BlueStacks_5_Root_ver.7.zip) и распакуйте его.  
**5.** Запустите Project Maker для ZDE и откройте проект из архива, который называется *Bluestacks5RootMagisk_v7*.  
...
### Видеоинструкция.  
> Получение Root-прав в MSI App Player при помощи шаблона *Bluestacks5RootMagisk_v7* и Magisk 30.7.  
