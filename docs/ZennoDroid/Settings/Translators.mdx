---
sidebar_position: 9
sidebar_label: Переводчики
title: Переводчики | Документация ZennoDroid | ZennoLab
description: Переводчики - раздел официальной документации ZennoDroid от ZennoLab. Подробные инструкции, примеры использования и руководство по настройке
---  
# Переводчики
...
1. Получаем строку с текстом из [**Списка**](../project-editor/lists-and-sheets/Lists).  
