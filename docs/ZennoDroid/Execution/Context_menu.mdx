---
sidebar_position: 6
sidebar_label: Контекстное меню
title: Контекстное меню | Документация ZennoDroid | ZennoLab
description: Контекстное меню - раздел официальной документации ZennoDroid от ZennoLab. Подробные инструкции, примеры использования и руководство по настройке
---  
...
## Пункты меню.  
### Настройки.  
Этот пункт открывает [**Входные настройки**](../project-editor/Project/InputSetting) проекта.  
...
:::info **Во вкладке [*Настройки проекта*](../project-editor/static-block-panel/ProjectSettings) при этом должно быть выставлено количество потоков и повторений.**
:::
...
Вы можете заранее создать несколько файлов с настройками и затем загружать их с помощью экшена [**Запуск программ**](../project-editor/custom-code/RunningPrograms). Или же через действие [**Работа с файлами**](../Android/pro-lite/Files) динамически создавать файл, а потом сохранять в него все данные и подгружать по необходимости.  
