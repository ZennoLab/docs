---
sidebar_position: 15
sidebar_label: Установка Clash (Box for Root)
title: Установка Clash (Box for Root) | Документация ZennoDroid | ZennoLab
description: Установка Clash (Box for Root) - раздел официальной документации ZennoDroid от ZennoLab. Подробные инструкции, примеры использования и руководство по настройке
---
import DisclaimerNotice from '@site/src/components/DisclaimerNotice';

# Установка Clash (Box for Root)
<DisclaimerNotice />
