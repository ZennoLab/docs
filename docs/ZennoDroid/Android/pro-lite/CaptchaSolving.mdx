---
sidebar_position: 13
sidebar_label: Распознать капчу
title: Распознать капчу | Документация ZennoDroid | ZennoLab
description: Распознать капчу - раздел официальной документации ZennoDroid от ZennoLab. Подробные инструкции, примеры использования и руководство по настройке
---
...
Их содержание можно превратить в изображение и отправить на сервис для распознавание, а можно использовать [**JavaScript**](../../project-editor/custom-code/JS) из раздела **Свой код**.  
...
- [**POST-запрос**](../../project-editor/http-and-ftp/POST).   
