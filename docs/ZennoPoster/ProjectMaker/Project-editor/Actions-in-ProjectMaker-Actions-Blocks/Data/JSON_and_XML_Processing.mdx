...
| ![Здесь обработан XML из Описания](./assets/JSON_and_XML_Processing/JSON_and_XML_Processing_pic3.png) |
| :--: |
...
| ![Подстановка данных из других переменных и результат работы (основано на данных приведённых в секции Описание. Нумерация начинается с нуля.)](./assets/JSON_and_XML_Processing/JSON_and_XML_Processing_pic6.png) |
| :--: |
...
| ![В переменной `{ -Variable.item_type- }` находится CD](./assets/JSON_and_XML_Processing/JSON_and_XML_Processing_pic12.png) |
| :--: |
...
| ![В переменной `{ -Variable.item_type- }` находится CD, а в `{ -Variable.property- }`- ARTIST](./assets/JSON_and_XML_Processing/JSON_and_XML_Processing_pic13.png) |
| :--: |
...
| ![Настройки экшена и результат его работы (справа)](./assets/JSON_and_XML_Processing/JSON_and_XML_Processing_pic17.png) |
| :--: |
