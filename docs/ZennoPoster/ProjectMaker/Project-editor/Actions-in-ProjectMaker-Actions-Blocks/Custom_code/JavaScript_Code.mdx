...
| ![В результате выполнения этого экшена в переменную проекта result сохранится результат деления переменной проекта height на 2](./assets/JavaScript_Code/JavaScript_Code_pic5.png) |
| :--: |
