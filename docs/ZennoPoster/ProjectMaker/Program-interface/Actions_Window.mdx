...
:::info Умный поиск понимает альтернативные названия.
Например: *регулярка*
:::
...
:::info Действие создаётся сразу с выбранной функцией
...
Открыв **контекстное меню** правой кнопкой мыши в любой части окна проекта.
...
<VideoSample source={require("@site/static/video/toolbox.mp4").default}/>
