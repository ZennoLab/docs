...
В каталог настроек также можно попасть, вызвав окно **Выполнить (`Win+R`)**, введя в него строку `%appdata%\ZennoLab` и нажав **ОК**.

![image-20211017-073621](./assets/Uninstalling_the_Program/Uninstalling_the_Program_pic5.png)

:::caution **Настройки в AppData едины для всех установленных версий программы!**
