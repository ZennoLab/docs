...
![image-20210312-114052](./assets/Если_geo_база_не_загружается_средствами_ZennoPoster/Если_geo_база_не_загружается_средствами_ZennoPoster_pic1.png)


3. Нажать пункт Download files и выбрать GeoLite2 City в binary формате, нажать Download GZIP

![image-20210312-114305](./assets/Если_geo_база_не_загружается_средствами_ZennoPoster/Если_geo_база_не_загружается_средствами_ZennoPoster_pic2.png)
