...
Этот метод изменяет конфигурацию существующего прокси-сервера на основе указанных параметров. 
...
| name | string |  | (empty) | Новое имя прокси. Установите null, чтобы сохранить текущее имя |
