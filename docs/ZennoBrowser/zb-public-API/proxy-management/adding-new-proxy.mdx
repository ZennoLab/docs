...
Этот метод используется для добавления новой записи прокси с использованием заданных параметров конфигурации. Возвращает сгенерированный уникальный идентификатор.
