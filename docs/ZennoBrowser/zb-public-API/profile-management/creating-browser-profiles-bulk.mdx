...
| memory | string |  | (пусто) | Настройки конфигурации памяти. Допустимые значения: “auto” — использовать значение из отпечатка, “ignore” — использовать системное значение или целое число для указания собственного размера памяти в мегабайтах (auto, ignore или размер памяти в МБ) |
