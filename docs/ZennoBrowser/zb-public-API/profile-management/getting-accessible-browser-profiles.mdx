...
Этот метод получает список профилей с их атрибутами из указанного рабочего пространства и папки. Можно дополнительно фильтровать результаты по ID, имени, тегам и параметрам сортировки.
