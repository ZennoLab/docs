...
Этот метод останавливает несколько существующих экземпляров браузера, связанных с указанными профилями. Эта операция безвозвратно закрывает все указанные экземпляры браузера и освобождает их ресурсы.
