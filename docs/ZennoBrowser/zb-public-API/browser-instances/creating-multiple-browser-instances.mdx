...
**Cube:**  
```
http://localhost:8160/v1/browser_instances/create_bulk?workspaceId=-1&desktopName=Desktop 1&keepAlive=true&environmentTags=&commandLineArguments=--disable-gpu&customFeatures={}
```
**Body (JSON):**
```json
[
