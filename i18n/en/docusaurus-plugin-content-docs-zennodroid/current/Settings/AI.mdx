...
The key you enter here is also used by the [**AI assistant**](../introduction/ai-assistant) in ProjectMaker — it will not work without a connected model.
...
- [**MCP setup for AI assistants**](../introduction/MCP_Setup).
