...
ZennoDroid lets you solve text captchas manually. To do this, just pick the `MonkeyEnter.dll` module in the [**Captcha Recognition Action**](../Android/pro-lite/CaptchaSolving). But doing this by hand can become a real chore when you have to deal with hundreds or thousands of captchas!
...
Once you've added your module, you'll be able to pick it in the [**Solve captcha**](../Android/pro-lite/CaptchaSolving) action.
