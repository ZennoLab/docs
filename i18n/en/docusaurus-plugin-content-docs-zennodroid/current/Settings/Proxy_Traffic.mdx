...
## Description
ZennoDroid lets you choose how you want to proxy traffic when running the [**Set Proxy**](../Android/ProLite/setting#how-to-set-up-a-proxy) action.

You set this up on the [**Android Settings**](../Android/ProLite/setting#how-to-set-up-a-proxy) tab. By default, **Proxifier** is used.
...
_______________________________________________
## Useful links
- [**Android Settings. Setting up a proxy.**](../Android/ProLite/setting#how-to-set-up-a-proxy)