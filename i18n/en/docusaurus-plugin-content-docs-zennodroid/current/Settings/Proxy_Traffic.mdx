---
sidebar_position: 11
sidebar_label: Traffic Proxying
title: Traffic Proxying | ZennoDroid Documentation | ZennoLab
description: Traffic Proxying - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
## Description
ZennoDroid lets you choose how you want to proxy traffic when running the [**Set Proxy**](../Android/pro-lite/setting#how-to-set-up-a-proxy) action.

You set this up on the [**Android Settings**](../Android/pro-lite/setting#how-to-set-up-a-proxy) tab. By default, **Proxifier** is used.
...
_______________________________________________
## Useful links
- [**Android Settings. Setting up a proxy.**](../Android/pro-lite/setting#how-to-set-up-a-proxy)