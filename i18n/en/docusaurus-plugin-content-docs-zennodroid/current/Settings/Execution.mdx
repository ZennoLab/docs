...
title: Execution | ZennoDroid Documentation | ZennoLab
description: Execution - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
The number of times the program will try to execute an [**HTTP request**](../project-editor/http-and-ftp/HTTP).
_______________________________________________
...
This option optimizes working with [**HTTP requests**](../project-editor/http-and-ftp/HTTP), making it more stable.
_______________________________________________
...
_______________________________________________
### Take into Account Group Order when Doing a Classic Element Search.
...
Enables a detailed log for [**email operations**](../project-editor/RecieveEmails).
_______________________________________________
### Detailed Log for FTP operations.
Enables a detailed log for [**FTP operations**](../project-editor/http-and-ftp/FTP_Dir).
_______________________________________________
### Detailed Log for HTTP operations.
Enables a detailed log for [**HTTP operations**](../project-editor/http-and-ftp/HTTP).
_______________________________________________
...
_______________________________________________
## Useful links.
- [**Send mail**](../project-editor/SendEmails).
- [**HTTP requests**](../project-editor/http-and-ftp/HTTP).
- [**FTP connection**](../project-editor/http-and-ftp/FTP_Connect).