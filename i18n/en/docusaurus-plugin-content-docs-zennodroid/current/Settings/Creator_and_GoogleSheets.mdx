---
sidebar_position: 16
sidebar_label: Google Spreadsheets
title: Google Spreadsheets | ZennoDroid Documentation | ZennoLab
description: Google Spreadsheets - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
In this article, we cover **only** *setting up Google Sheets* in the program. [You can find connection instructions here](../project-editor/lists-and-sheets/Connecting_GoogleSheets).

### How it Looks
![Google Sheets](./assets/Creator_and_GoogleSheets/Creator_and_GoogleSheets_pic4.png)

### Path to the Google OAuth Key
Here you need to select the path to the file with your [Google API connection settings](../project-editor/lists-and-sheets/Connecting_GoogleSheets).
...
## Useful Link
- [**Connecting Google Sheets**](../project-editor/lists-and-sheets/Connecting_GoogleSheets)