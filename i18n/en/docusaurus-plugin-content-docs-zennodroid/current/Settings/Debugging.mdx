...
sidebar_position: 5
sidebar_label: Debug
title: Debug | ZennoDroid Documentation | ZennoLab
description: Debug - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
- `If statement execution Result: false` if the [**IF**](../project-editor/Logic/IF) action follows the red branch.
...
If this option is enabled, an action can transfer execution to [**BadEnd**](../project-editor/Logic/BadEnd) or [**GoodEnd**](../project-editor/Logic/GoodEnd), depending on whether errors occur or things are going smoothly.
...
_______________________________________________
## Alert settings
This controls [**Notifications**](../project-editor/Logic/Notification) that pop up on your desktop.
