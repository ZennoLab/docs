---
sidebar_position: 11
sidebar_label: Traffic Proxying (Enterprise)
title: Traffic Proxying (Enterprise) | ZennoDroid Documentation | ZennoLab
description: Traffic Proxying (Enterprise) - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
import DisclaimerNotice from '@site/src/components/DisclaimerNotice';

# Traffic Proxying (Enterprise)
<DisclaimerNotice />

## Description
ZennoDroid lets you choose how to proxy traffic when running the [**Set Proxy**](../Android/Enterprise/setting#how-to-set-up-a-proxy) action.

You can set up your preferences under the [**Android Settings**](../Android/Enterprise/setting#how-to-set-up-a-proxy) tab. By default, **Proxifier** is used.
...
You can do it manually or by running the [Console Commands](../Android/pro-lite/ADB_Shell) action:
