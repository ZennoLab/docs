...
sidebar_position: 14
sidebar_label: Other
title: Other | ZennoDroid Documentation | ZennoLab
description: Other - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
Messages sent using the [**Notification**](../project-editor/Logic/Notification) action will only show up in the log, without a popup window, no matter how the action’s settings are set.
