...
title: E-mail | ZennoDroid Documentation | ZennoLab
description: E-mail - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
## Description  
This settings section is for connecting mailboxes, which you can then use for [**sending emails**](../project-editor/SendEmails).
...
### Service Name  
A custom name for this account, which you make up yourself. This is how it’ll show up in the available list, for example, in the [**Send Mail**](../project-editor/SendEmails) action.
...
### Default  
If you switch this on, this connection will be used by default every time in [Mail Sending](../project-editor/SendEmails) blocks, unless you specify otherwise.
_______________________________________________
...
_______________________________________________  
## Useful Links  
- [**Receive Mail**](../project-editor/SendEmails)
