...
:::
ZennoDroid lets you choose how traffic is proxied when performing the [**Set proxy**](../../Android/Enterprise/setting#how-to-set-up-a-proxy) action.  

The parameters are configured on the [**Android Settings**](../../Android/Enterprise/setting#how-to-set-up-a-proxy) tab. By default, **Proxifier** is used.  
