...
description: Input Settings - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
In ZennoDroid, there are two types of input settings — [**Classic**](../project-editor/Project/InputSetting) and [**Bot Interface (BotUI)**](../project-editor/Project/BotInterface).
...
You can find more detailed info in the article about [**Profile**](../project-editor/static-block-panel/Profile)
...
- [**All About the Static Block Panel**](../project-editor/static-block-panel)  
