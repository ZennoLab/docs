...
1. You need to install the ***com.android.adbkeyboard.apk*** app on your phone (*the file is in the main program folder*). For example, use the [**Install App**](../Android/pro-lite/App#install-application) action.
