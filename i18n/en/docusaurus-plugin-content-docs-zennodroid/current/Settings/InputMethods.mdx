...
### Details
#### ZennoKeyboard
ZennoLab's own keyboard and the **default** input method. Like ADBKeyboard, it installs automatically when you connect your device and types characters as if you were using a virtual keyboard.
