...
title: Interface view | ZennoDroid Documentation | ZennoLab
description: Interface view - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
| Setting is enabled    | Setting is disabled    |
| :--------: | :--------: |
|  ![Draw shadow](./assets/Appearance/Appearance_pic11.png) |  ![No shadow](./assets/Appearance/Appearance_pic12.png) |
...
| Setting is enabled    | Setting is disabled    | 
| :--------: | :--------: |
|  ![Rounded corners](./assets/Appearance/Appearance_pic13.png) |  ![No rounded corners](./assets/Appearance/Appearance_pic14.png) |  
_______________________________________________
