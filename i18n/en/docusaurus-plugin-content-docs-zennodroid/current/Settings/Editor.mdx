...
title: Editor | ZennoDroid Documentation | ZennoLab
description: Editor - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
Lets you choose the font used in [**C#**](../project-editor/custom-code/С) and [**JavaScript**](../project-editor/custom-code/JS) code actions. By default, it’s *Consolas* at size 10.
...
Lines in [**C# code**](../project-editor/custom-code/С) will be automatically numbered.
...
This button lets you [**Encrypt**](../project-editor/static-block-panel/Encryption) all open projects at once.
_______________________________________________  
## Useful links  
- [**All about working with the editor**](../project-editor)  
- [**All about the static blocks panel**](../project-editor/static-block-panel)  
- [**Writing code in ZD**](../project-editor/custom-code)