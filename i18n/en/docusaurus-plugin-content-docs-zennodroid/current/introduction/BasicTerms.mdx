...
slug: /basicterms
title: Basic Concepts | ZennoDroid Documentation | ZennoLab
description: Basic Concepts - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples.
---  
...
- [get a value](Android/pro-lite/GetValue),
- [emulate a touch](Android/pro-lite/Touch_Emulation),
- [save an element's value](Android/pro-lite/SetValue),
