---
sidebar_position: 1
sidebar_label: Profile Operations
title: Profile Operations | ZennoDroid Documentation | ZennoLab
description: Profile Operations - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
<VideoSample source={require("@site/static/video/fGeUfiqbKk.mp4").default}/>
:::
...
Later, you can **Load your profile** and immediately get the needed variables. You can use them for your own activity logs. Add a [**Notification**](../project-editor/Logic/Notification) action and put this text in it:
```
Profile loaded.
