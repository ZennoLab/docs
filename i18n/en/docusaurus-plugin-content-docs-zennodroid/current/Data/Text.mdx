...
title: Text Processing | ZennoDroid Documentation | ZennoLab
description: Text Processing - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
**1.** Using the [**Get Value**](../Android/pro-lite/GetValue) action, get the HTML code that contains links to online users.  
...
This option is useful when building [**HTTP requests**](../project-editor/http-and-ftp/HTTP) because you only need to encode parameters, not the site address.
