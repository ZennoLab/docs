...
:::tip You can use the [*Regular Expression Tester*](../Tools/RegEx_Tester) to help write regexes.
...
Here’s how you could extract links using regular expressions that you build in the [** constructor**](../Tools/RegEx_Tester#конструктор-регулярных-выражений).
...
**2.** Add the **Regex** action. Build your pattern in the [**Regex Constructor**](../Tools/RegEx_Tester#конструктор-регулярных-выражений).  
...
#### One Match
![Add to project](./assets/Text/Text_pic24.png)
