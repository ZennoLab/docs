---
sidebar_position: 8
sidebar_label: Working with JSON and XML
title: Working with JSON and XML | ZennoDroid Documentation | ZennoLab
description: Working with JSON and XML - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
To get the information, make a [**GET request**](../project-editor/http-and-ftp/GET) to http://ip-api.com/json, then process the result with the *Parse* action. After that, you can work with the data you receive.
