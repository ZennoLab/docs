---
sidebar_position: 10
sidebar_label: Variables Processing
title: Variables Processing | ZennoDroid Documentation | ZennoLab
description: Variables Processing - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
Right-click to open the context menu: **Add Action → Data → Variables Processing.**
...
_______________________________________________
### Setting a Value
You can assign or change the values of variables. You can do this in the [**Variables Window**](../pm/Interface/Variables), or using this **Variables Processing** action.
...
_______________________________________________  
## Useful Links  
- [**IF Operator**](../project-editor/Logic/IF)
