---
sidebar_position: 3
sidebar_label: SMS Handling Services
title: SMS Handling Services | ZennoDroid Documentation | ZennoLab
description: SMS Handling Services - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
import DisclaimerNotice from '@site/src/components/DisclaimerNotice';

# SMS Handling Services
<DisclaimerNotice />
...
- [**Trigger Event**](../Android/pro-lite/RunEvent)
- [**Switch Operator**](../project-editor/Logic/Switch)