...
---
:::info **Please make sure to read the [*Terms and Conditions for using materials on this site*](../Disclaimer).**
:::
...
#### Status:
- **SMS Sent**: The message was successfully sent to the specified number.
- **Resend Code**: Use if you need to send another SMS.
- **Cancel Request**: Use if you no longer need the number. Some services might refund your money.
- **Number Already Used**: Lets the service know the number isn’t suitable because it’s already in use.
- **Complete**: Tells the service the task for this number is done.
