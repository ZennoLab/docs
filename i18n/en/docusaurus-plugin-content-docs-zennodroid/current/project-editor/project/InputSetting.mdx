---
sidebar_position: 2
sidebar_label: Input Settings
title: Input Settings | ZennoDroid Documentation | ZennoLab
description: Input Interface - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
#### Castomize profile.
Allows you to quickly adjust the parameters for generating the profiles you’re using (in a separate window).
_______________________________________________
