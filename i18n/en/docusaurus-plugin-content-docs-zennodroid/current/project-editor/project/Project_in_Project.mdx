---
sidebar_position: 1
sidebar_label: Project in Project
title: Project in Project | ZennoDroid Documentation | ZennoLab
description: Project in Project - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
- [**Working with variables**](../../pm/Interface/Variables#working-with-variables)