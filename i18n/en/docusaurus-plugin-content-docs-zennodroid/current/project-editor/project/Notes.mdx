...
sidebar_position: 4
sidebar_label: Notes
title: Notes | ZennoDroid Documentation | ZennoLab
description: Notes - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
- [**Recognize captcha**](../../Android/pro-lite/CaptchaSolving).
