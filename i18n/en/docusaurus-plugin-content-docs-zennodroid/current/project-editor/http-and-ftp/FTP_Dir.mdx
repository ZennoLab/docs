---
sidebar_position: 5
sidebar_label: FTP Directories
title: FTP Directories | ZennoDroid Documentation | ZennoLab
description: FTP Directories - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
_______________________________________________
### Available settings:  
| ![Available settings](./assets/FTP_Dir/FTP_Dir_pic4.png)    | ![Available settings](./assets/FTP_Dir/FTP_Dir_pic6.png) |
| :--------: | :-------: |
| Standart  | An extra option for *Get a list of files*    |
