---
sidebar_position: 3
sidebar_label: Run the Program
title: Run the Program | ZennoDroid Documentation | ZennoLab
description: Run the Program - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
# Run the Program
...
Through the context menu: **Add Action → Custom code → Run the program**.
