---
sidebar_position: 4
sidebar_label: GAC References
title: GAC References | ZennoDroid Documentation | ZennoLab
description: GAC References - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---  
...
Via the context menu: **Add action → Custom code → GAC References**.

![How to add to your project](./assets/GAC_reference/GAC_reference_pic1.png)

Or through the **[*Static Block Panel*](../static-block-panel/CommonPrinciples) → Add → Add GAC Link**:
...
When you open the action or the corresponding item from the [*Static Block Panel*](../static-block-panel/CommonPrinciples), a window pops up that lists all the libraries currently connected.
