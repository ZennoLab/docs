---
sidebar_position: 5
sidebar_label: Using Directives and Shared Code
title: Using Directives and Shared Code | ZennoDroid Documentation | ZennoLab
description: Using Directives and Shared Code - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
Or through the **[*Static block panel*](../static-block-panel/CommonPrinciples) → Add → Add using directives and shared code**:
