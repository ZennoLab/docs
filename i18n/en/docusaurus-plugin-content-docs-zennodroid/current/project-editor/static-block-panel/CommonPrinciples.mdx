...
title: General Principles | ZennoDroid Documentation | ZennoLab
description: General Principles - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
--- 
# General Principles
...
**Right-click on the block → Remove:**  
