...
title: Protection | ZennoDroid Documentation | ZennoLab
description: Protection - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
# Protection
...
_______________________________________________
### Permissions
| Email              | Execute | Read | Change | Full access |
| :----------------: | :------: | :----: |:------: | :----: |
