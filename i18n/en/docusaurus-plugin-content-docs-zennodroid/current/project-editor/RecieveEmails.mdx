---
sidebar_position: 1
sidebar_label: Receive e-mails
title: Receive e-mails | ZennoDroid Documentation | ZennoLab
description: Receive e-mails - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
# Receive e-mails
...
Right-click menu: **Add Action → Work with mail → Receive e-mails**.
...
#### Load from the catalog no more than
