---
sidebar_position: 3
sidebar_label: Get Proxy
title: Get Proxy | ZennoDroid Documentation | ZennoLab
description: Get Proxy - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
If you choose ***Without rules***, proxies will be taken in order.

And the option **Delete proxy from live list** deletes the proxy server from the list after you take it.
