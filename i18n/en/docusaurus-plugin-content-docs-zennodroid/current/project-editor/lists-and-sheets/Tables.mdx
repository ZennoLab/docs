...
sidebar_position: 3
sidebar_label: Table
title: Table | ZennoDroid Documentation | ZennoLab
description: Table - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
--- 
...
- **First line — headers**. Use the first row of the table as headers  
- **Display non-latin characters correctly in .csv files**  
- **Parse the data type (if possible)**. Figures out the data type in the contents  
- **Separator for the .csv format**. Choices: `;` and `,`  
