---
sidebar_position: 7
sidebar_label: Operations and Multithreaded Work with Google Sheets
title: Operations and Multithreaded Work with Google Sheets | ZennoDroid Documentation | ZennoLab
description: Operations and Multithreaded Work with Google Sheets - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
# Operations and Multithreaded Work with Google Sheets
...
- **Link to an existing Google spreadsheet**. Here, you specify the link to the spreadsheet where you want to create a new sheet.
- **New sheet name**. Set the name for the new sheet here.
- **Put URL to variable**. Specify the variable where the link to the new sheet will be saved.
_______________________________________________
...
- **New table name**. Make up a name for your sheet.
- **New sheet name**. Set the name for the sheet here.
- **Put URL to variable**. Specify the variable where the link to the new spreadsheet will be saved.
_______________________________________________
