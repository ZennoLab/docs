---
sidebar_position: 5
sidebar_label: BadEnd
title: BadEnd | ZennoDroid Documentation | ZennoLab
description: BadEnd - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---  
...
Since it's hard to catch every error, we suggest logging them into a file. For this, after **BadEnd**, add the [**Write to file**](../../Android/pro-lite/Files) cube and paste this text in:  
```  
