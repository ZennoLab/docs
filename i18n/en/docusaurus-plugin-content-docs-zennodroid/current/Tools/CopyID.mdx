...
All you need to do is select **Copy All Action IDs** from the **File** menu at the top, and all the data will be copied to your clipboard automatically. After that, you can just paste it into any text editor.
_______________________________________________
## Data Format  
