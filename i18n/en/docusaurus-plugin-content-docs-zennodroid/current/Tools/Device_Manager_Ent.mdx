...
- **Name**. By default, matches the device identifier. But for convenience, you can give it a more specific name. To do this:  
    ...
    - or use the [**Rename**](../Android/Enterprise/action#как-переименовать-устройство) action.  
...
![in the status bar](./assets/Device_Manager/Device_Manager_pic7.png)  
...
This is an alternative to the [**Stop**](../Android/Enterprise/action#как-остановить-устройство) action.  
