...
- **Name**: By default, all devices are named `MEmu+Index`. To make it easier to tell them apart, you can give each one a specific name. You can do this by:
    ...
    - or using the [**Rename**](../Android/ProLite/action#how-to-rename-a-device) action.
...
This is an alternative to the [**Stop**](../Android/ProLite/action#how-to-stop-a-device) action.
_______________________________________________  
## Useful links  
