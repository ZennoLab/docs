---
sidebar_position: 5
sidebar_label: E-mail Processing
title: E-mail Processing | ZennoDroid Documentation | ZennoLab
description: E-mail Processing - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
ZennoDroid will suggest adding an action [**Receive mail**](../project-editor/RecieveEmails) to the project so you can use it later.
...
_______________________________________________  
## Useful links  
- [**Receive mail**](../project-editor/RecieveEmails)  
