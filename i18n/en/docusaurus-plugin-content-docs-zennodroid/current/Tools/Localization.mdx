---
sidebar_position: 10
sidebar_label: Project Localization
title: Project Localization | ZennoDroid Documentation | ZennoLab
description: Project Localization - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
You can add the translation file to your project as a static [**Table**](../project-editor/lists-and-sheets/Tables) block or a [**Google Sheet**](../project-editor/lists-and-sheets/Google_Sheet) after importing it to Google Docs.  
...
To make a table, use the top menu in ProjectMaker: **File → Create localization file**  
...
_______________________________________________  
## Useful links  
- [**Notes**](../project-editor/Project/Notes)  
