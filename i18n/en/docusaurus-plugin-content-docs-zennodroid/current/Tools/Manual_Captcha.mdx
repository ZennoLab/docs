---
sidebar_position: 6
sidebar_label: Enter CAPTCHA manually
title: Enter CAPTCHA manually | ZennoDroid Documentation | ZennoLab
description: Enter CAPTCHA manually - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
*This shows up when you send an image from the [**Solve Captcha**](../Android/pro-lite/CaptchaSolving) action.*  
_______________________________________________
## How to Use the Tool?  
### Getting Ready  
First add the [**Solve Captcha**](../Android/pro-lite/CaptchaSolving) action to your project and choose the **`MonkeyEnter.dll`** recognition module from the list.
...
Then press **Enter** to confirm. The answer will be saved in the variable you set in the [**Solve Captcha**](../Android/pro-lite/CaptchaSolving) action settings.
...
1. Add the [**Solve Captcha**](../Android/pro-lite/CaptchaSolving) action to your project.
...
- [**Solve Captcha**](../Android/pro-lite/CaptchaSolving)
