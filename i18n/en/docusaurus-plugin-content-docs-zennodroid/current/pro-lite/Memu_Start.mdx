---
sidebar_position: 5
sidebar_label: Launching the Emulator
title: Launching the Emulator | ZennoDroid Documentation | ZennoLab
description: Launching the Emulator - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
In the **Device Window**, click the **Run Device** button and wait for the emulator to be ready:
...
:::tip Before you hit the Run button, you can enable Recording right away so your actions are saved in a template for future use.
