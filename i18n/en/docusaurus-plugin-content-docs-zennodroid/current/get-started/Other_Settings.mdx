---
sidebar_position: 6
sidebar_label: Other Settings
title: Other Settings | ZennoDroid Documentation | ZennoLab
description: Other Settings - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
### Disable the task setting recovery dialog.
...
_______________________________________________
## Log settings [Settings](../pm/Interface/Log_window).
...
Notifications sent using the [**Notification**](../project-editor/Logic/Notification) action will just go to the log, with no pop-up window, no matter how the action is set.
...
_______________________________________________
### Show notification in log if the project was not completed successfully.
...
- [**What settings are there?**](../Settings)