---
sidebar_position: 5
sidebar_label: ProxyChecker Interface Overview for ZD 
title: ProxyChecker Interface Overview for ZD | ZennoDroid Documentation | ZennoLab
description: ProxyChecker Interface Overview for ZD - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
import DisclaimerNotice from '@site/src/components/DisclaimerNotice';


# ProxyChecker Interface Overview for ZD 
<DisclaimerNotice />
...
- **Insert a proxy directly into the program.** When you choose this, an empty window opens for you to add proxies.
...
- **Path to the list of proxy sources.** Like option two, but you can enter multiple paths.
_________________
### Main Sources Window
...
- **Re-check the live ones.** Lets you recheck already found live proxies from sources.
- **Expand.** Expands the group with the source list if it was collapsed before.
- **Minimize.** Collapses the list.
...
- **Loading time.** Adds three new columns to the table.

![Load Time](./assets/ProxyChecker/ProxyCheck_pic29.png)

- **Remove all proxies.** Wipes all proxies from the program.
- **Black list.** If proxies don't fit your project or you don't trust the source, you can add it to the blacklist.
...
- [**ProjectMaker Interface**](../pm/Interface)
