...
:::info **Please read the [*Terms of Use for content on this resource*](../Disclaimer).**
:::
...
1. Right-click the blocks area → **Add action → [Android → App Actions](../Android/ProLite/App#сохранить-данные-приложения).**
...
2. Repeat the last step, but pick [**Restore app data**](../Android/ProLite/App#восстановить-данные-приложения) as the action. Specify the path to your backup archive.
