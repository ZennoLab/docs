...
- **Source**  
The full structure of elements on the screen. It's the same as what you get in the action [**Get element structure (XML)**](./Utilities#получить-структуру-элементов-xml).
- **Text**  
