...
sidebar_position: 3
sidebar_label: Utils
title: Utils | ZennoDroid Documentation | ZennoLab
description: Utils - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
***Right-click → Add Action → Android → Utils***
...
:::info **On LDPlayer the action does nothing - the list marks it *(not supported)*.**
:::
_______________________________________________
...
_______________________________________________
### Appium settings  
:::info **Added in ZennoDroid v2.4.3.0.**
:::
Changes which elements make it into the device's element tree.  
![Appium settings](../assets/Utilities/Utilities_pic18.png)  
#### Available parameters:  
- *Allow invisible webview.* Fixes the case where the element tree stops being built while a large page is open.  
- *Allow invisible elements.* The element tree shows every element of the screen, including the ones beyond its edges.  
- *Ignore unimportant views.* The tree is built without the secondary elements that carry no useful information.  
_______________________________________________
### Scaling  
