---
sidebar_position: 13
sidebar_label: Recognize Captcha
title: Recognize Captcha | ZennoDroid Documentation | ZennoLab
description: Recognize Captcha - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
_______________________________________________ 
### "More" tab  
| !["Advanced" tab](../assets/CaptchaSolving/CaptchaSolving_pic10.png) | !["Advanced" tab](../assets/CaptchaSolving/CaptchaSolving_pic13.png) |
| :--------: | :-------: |
| **When opened through the emulator/device window** | **Through context menu** |  
...
Check **Stick captchas** for the first item. Then, right-click each following item and choose **Stick to the captcha** from the context menu.
...
3. Template keeps running up to the **Wait for captcha** action.  
...
You can turn these into images and send them for recognition, or simply use [**JavaScript**](../../project-editor/custom-code/JS) from the **Your code** section.
...
- [**POST request**](../../project-editor/http-and-ftp/POST)  
