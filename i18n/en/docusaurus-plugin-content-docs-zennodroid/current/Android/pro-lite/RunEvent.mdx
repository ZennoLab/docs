---
sidebar_position: 9
sidebar_label: Rise Event
title: Rise Event | ZennoDroid Documentation | ZennoLab
description: Rise Event - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
- **Specify manually**. You can also set specific coordinates inside the found element to tap on.  
- **At random**.  
...
**1**. Right-click the shortcut → **To the Action Designer**.  
