---
sidebar_position: 10
sidebar_label: Touch Emulation
title: Touch Emulation | ZennoDroid Documentation | ZennoLab
description: Touch Emulation - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
***Right-click → Add Action → Android → Touch emulation***
...
- **Equally**: Taps will be distributed evenly within the set coordinates
_______________________________________________