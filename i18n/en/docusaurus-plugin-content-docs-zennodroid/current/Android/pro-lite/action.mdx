---
sidebar_position: 1
sidebar_label: Actions with Device
title: Actions with Device | ZennoDroid Documentation | ZennoLab
description: Actions with Device - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
On MEmu: **5.1, 7.1, 7.1 x64, 9.0 x64, 12.0 x64** and **Random**, which picks one of the installed images. On LDPlayer 9 the only value is **9.0 x64**, on LDPlayer 14 - **14.0 x64**.
...
:::info **On LDPlayer the copy is saved to an *.ldbk* file, and the field is called "Path to LDBK file".**
:::
...
:::info **On LDPlayer an *.ldbk* file is picked.**
:::
- ***Name***  
