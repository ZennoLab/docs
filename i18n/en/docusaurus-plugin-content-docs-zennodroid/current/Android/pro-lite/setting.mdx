...
title: Device Settings | ZennoDroid Documentation | ZennoLab
...
:::info **On LDPlayer the setting does nothing - the list marks it *(not supported)*.**
:::
:::warning **Before changing settings, make sure the device is powered off.**
:::  
_______________________________________________ 
...
_______________________________________________
## GPU settings  
:::info **Available for emulators starting from ZennoDroid v2.6.1.0.**
:::
...
_______________________________________________  
## Useful links      
- [**Launching the emulator**](../../pro-lite/Memu_Start)   
