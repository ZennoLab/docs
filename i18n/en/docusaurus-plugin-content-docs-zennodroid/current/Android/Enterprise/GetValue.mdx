...
title: Get Value | ZennoDroid Documentation | ZennoLab
description: Get Value - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
After that, the [**Action Designer**](../../pm/Interface/ActionBuilder) opens at the bottom under the browser window.
...
- With [**App Actions. Open App**](./App#open-application)  
