...
[+] Instructions for intercepting traffic via **Burp** have been updated. [New video tutorials on setting up traffic interception with Frida and Burp Suite](../Tools/Frida#updated-video-tutorial-for-zennodroid-2470-and-later).
