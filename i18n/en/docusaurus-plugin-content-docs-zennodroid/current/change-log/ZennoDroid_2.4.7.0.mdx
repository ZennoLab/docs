...
[+] Instructions for intercepting traffic via **Burp** have been updated. [New video tutorials on setting up traffic interception with Frida and Burp Suite](../Enterprise/BurpSuite).
