...
+ Clash has been updated to version 1.19.15. For automatic updating, you need to remove the current version first. [Documentation](../Android/Enterprise/Clash#automatic-updating).
