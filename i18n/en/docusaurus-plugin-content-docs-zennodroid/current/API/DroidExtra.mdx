...
title: Extra API | ZennoDroid Documentation | ZennoLab
description: Extra API - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
<DisclaimerNotice />
## Description  
This section contains a list of interfaces that are not included in the main [DroidInstance API](./DroidInstance) container and that also have their own classes for creating objects.  
