...
Gives you access to emulate actions on your device for interacting with the interface and app elements. You use this interface to perform swipes, taps, and enter text, as well as execute [**ADB Shell commands**](../Android/ProLite/Utilities#консольная-команда-adb-shell).
_______________________________________________
## Methods 
...
```
_______________________________________________
### Execute an [**ADB Shell**](../Android/ProLite/Utilities#консольная-команда-adb-shell) command
```csharp
