...
Gives you access to emulate actions on your device for interacting with the interface and app elements. You use this interface to perform swipes, taps, and enter text, as well as execute [**ADB Shell commands**](../Android/pro-lite/Utilities#console-command-adb-shell).
...
```
_______________________________________________
### Execute an [**ADB Shell**](../Android/pro-lite/Utilities#console-command-adb-shell) command
```csharp
...
```
_______________________________________________
You can read about the **difference between ways of sending keystrokes** in detail in the [**ADB Shell Commands**](../Android/pro-lite/Utilities#console-command-adb-shell).