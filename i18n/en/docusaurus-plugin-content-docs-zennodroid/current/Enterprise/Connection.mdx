---
sidebar_position: 4
sidebar_label: Connecting a Real Device
title: Connecting a Real Device | ZennoDroid Documentation | ZennoLab
...
![Software information](./assets/devices_pic2.png)
...
<details>
<summary>*If you also see settings for **"Install via USB"** and **"USB debugging (Security Settings)"**, turn these on too for proper operation.*</summary>
...
### 3. Start [**ProjectMaker for ZennoDroid**](../pm).
