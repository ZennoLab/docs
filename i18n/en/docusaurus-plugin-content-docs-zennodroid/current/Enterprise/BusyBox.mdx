---
sidebar_position: 6
sidebar_label: Installing BusyBox
title: Installing BusyBox | ZennoDroid Documentation | ZennoLab
description: Installing BusyBox - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
- [Saving and restoring app data](../Android/Enterprise/App#save-applications-data)
