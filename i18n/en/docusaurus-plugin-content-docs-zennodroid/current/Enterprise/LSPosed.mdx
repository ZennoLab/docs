...
> [**Special build v1.11.0**](https://github.com/AnatolyJacobs/LSPosed_CLI/releases/tag/v1.11.0_cli_auto)
...
- Not all apps appear in the list by default. If you don’t see the app you need (like Google Chrome), go to the *Hide* menu and uncheck the right group.
...
### Video tutorial   
> Setting up the ZennoDroid and the [FLAG_SECURE](https://github.com/VarunS2002/Xposed-Disable-FLAG_SECURE/releases/tag/2.0.0) modules, which allows viewing secured pages.  
...
- [**Latest version of LSPosed Framework**](https://github.com/AnatolyJacobs/LSPosed_CLI/releases/tag/v1.11.0_cli_auto)
