---
sidebar_position: 6
sidebar_label: Choosing and Starting a Virtual Machine
title: Choosing and Starting a Virtual Machine | ZennoDroid Documentation | ZennoLab
description: Choosing and Starting a Virtual Machine - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
First, you need to choose a VM for your current thread. Do this with the [**Choose**](../../Android/pro-lite/action#how-do-i-select-a-device) action shown in the screenshot above.
_______________________________________________
### How to Choose a VM Correctly
The simplest option is random selection. To do this, leave the *"Full name or index"* field blank in the [**Choose**](../../Android/pro-lite/action#how-do-i-select-a-device) action settings. In the name and index fields below, enter variables they'll be saved to.

With this approach, ZennoDroid will look for available VMs that aren't busy right now.
:::warning **Important**
The virtual machine set as **default** in [**Settings**](../../Settings/Settings_for_Android#use-default-device) always counts as busy and will be skipped during random selection.
:::
_______________________________________________
## Starting a Virtual Machine
![Starting](./assets/ChooseVM/ChooseVM_pic2.png)  

Once you've chosen a VM, you need to start it. Use the [**Start\Restart**](../../Android/pro-lite/action#how-do-i-start-or-restart-a-device) action for that.
_______________________________________________
## Useful links
