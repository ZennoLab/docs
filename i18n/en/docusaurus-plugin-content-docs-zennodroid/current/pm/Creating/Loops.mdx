---
sidebar_position: 5
sidebar_label: Cycles (loops) in ZD
title: Cycles (loops) in ZD | ZennoDroid Documentation | ZennoLab
description: Cycles (loops) in ZD - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
After clicking *OK*, the data from the condition field moves to [**IF action**](../../project-editor/Logic/IF), so be sure to stick to proper expression syntax.
...
_______________________________________________
## Useful links.
- [**Logic in ZennoDroid**](../../project-editor/logic). 
- [**Writing code in ZennoDroid**](../../project-editor/custom-code).     
