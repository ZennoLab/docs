---
sidebar_position: 3
sidebar_label: Value Ranges
title: Value Ranges | ZennoDroid Documentation | ZennoLab
description: Value Ranges - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
--- 
...
- As the match number when running actions: [**Run Event**](../../Android/pro-lite/RunEvent), [**Set Values**](../../Android/pro-lite/SetValue), [**Get Values**](../../Android/pro-lite/GetValue).  
...
- [**ZD Logic**](../../project-editor/logic).  
- [**Lists and Tables**](../../project-editor/lists-and-sheets).