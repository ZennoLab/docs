---
sidebar_position: 7
sidebar_label: Search elements
title: Search elements | ZennoDroid Documentation | ZennoLab
description: Search elements - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
- [**Getting a value**](../../Android/pro-lite/GetValue)  
- [**Setting a value**](../../Android/pro-lite/SetValue)  
- [**Triggering an event**](../../Android/pro-lite/RunEvent)  
