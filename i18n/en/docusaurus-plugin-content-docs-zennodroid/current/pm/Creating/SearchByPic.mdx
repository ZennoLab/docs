---
sidebar_position: 2
sidebar_label: Search by picture
title: Search by picture | ZennoDroid Documentation | ZennoLab
description: Search by picture - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
for clicking on elements you can't reach using the [**Run Event**](../../Android/pro-lite/RunEvent) action.
_______________________________________________ 
## How does this action work?  
![Action](./assets/SearchByPic/SearchByPic_pic1.png)
_______________________________________________   
### Adding to your project.  
In the emulator window, **hover your mouse over the element** **→ right-click → Search by picture**.
...
- **Full screen**. The search covers the whole screen.
- **Highlighted area**. This mode lets you pick the search area in the [Device window](../Interface/DeviceWindow), like shown earlier. Use this if you know the element will show up in a certain part of the screen.
:::tip **Searching in a specified area is faster and loads the CPU less.**
:::
_______________________________________________  
### Search.  
![Search](./assets/SearchByPic/SearchByPic_pic7.png)  
- **Accuracy**. Adjusts the search accuracy. The higher it is, the more resources and time it uses.
...
![Hiding](./assets/SearchByPic/SearchByPic_pic14.png)
## "More" tab.  
...
- **Waiting for element**. Time (in seconds) the action will wait for the element to appear. In [*Recording settings*](../../Settings/Record_and_InputMethods) you can set the default search time for all new actions.
- **Look in**. Here you can set the area manually or using variables.
