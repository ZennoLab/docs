---
sidebar_position: 1
sidebar_label: Variables Window
title: Variables Window | ZennoDroid Documentation | ZennoLab
description: Variables Window - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
## How do you open it?  
### First way.  
Click the button with four squares on the [**Static Blocks Panel**](../../project-editor/static-block-panel):  
...
_______________________________________________   
- **Auto.**  
Generated automatically in **Project Recording** mode or when adding some blocks (like [**Android → Get Value**](../../Android/pro-lite/GetValue)).   
...
- [**Static Blocks Panel**](../../project-editor/static-block-panel/CommonPrinciples).