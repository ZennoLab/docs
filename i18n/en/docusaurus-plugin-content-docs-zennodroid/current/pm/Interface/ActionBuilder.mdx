...
## How to open it?
#### There are two ways:  
- Right-click on the desired element in the **Device Window** → **To Action Builder** from the context menu.  

![First way](./assets/ActionBuilder/ActionBuilder_pic1.png) 
_______________________________________________ 
- From the [**Element Tree**](./ElementTree) window → right-click on the element you're interested in → **To Action Builder**.  

![Second way](./assets/ActionBuilder/ActionBuilder_pic2.png)  
_______________________________________________ 
:::info **Useful.**
When you add an element to the **Action Builder**, all its properties and attributes are automatically sent to the [**Element Properties**](./ElementProp) window.  
