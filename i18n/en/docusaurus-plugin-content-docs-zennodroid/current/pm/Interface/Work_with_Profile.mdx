---
sidebar_position: 6
sidebar_label: Profile Window
title: Profile Window | ZennoDroid Documentation | ZennoLab
description: Profile Window - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---  
...
_______________________________________________ 
### Manually.
In any field that supports variable macros (for example, in the [**Notification**](../../project-editor/Logic/Notification) action), press `Ctrl+Space`. Find `{}Profile` and click on it. Then type a dot to bring up another dropdown with all the profile variables. Double-click any variable you need and it'll insert automatically.  

| CTRL + space  | Selecting the required field | The final look of the macro |
| :----------------: | :------: | :----: |
