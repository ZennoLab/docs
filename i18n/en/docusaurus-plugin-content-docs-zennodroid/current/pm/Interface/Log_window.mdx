---
sidebar_position: 9
sidebar_label: Log Window
title: Log Window | ZennoDroid Documentation | ZennoLab
description: Log Window - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---  
...
<!--All you need is a blank line-->
    ...
    **WARNING**: *The following steps will reset your window layout. If you've set up the interface to your own liking, all those settings will be wiped and things will go back to default.*
    ...
    ![Log isn't showing up](./assets/Log_Window/Log_window_pic26.png)  
...
_______________________________________________ 
## Extended log window  
Turn on via *Edit → Settings → Debug →*  ***Extended window for log***.
...
For this, you'll need to use the [**Custom C# code**](../../project-editor/custom-code/С) block and basic C# code knowledge. You can't write to this column using the standard *Notification* action.
...
- [**Notification**](../../project-editor/Logic/Notification)  
