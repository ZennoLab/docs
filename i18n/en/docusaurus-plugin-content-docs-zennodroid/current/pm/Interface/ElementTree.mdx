---
sidebar_position: 2
sidebar_label: Element Tree
title: Element Tree | ZennoDroid Documentation | ZennoLab
description: Element Tree - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
[**Get element structure (XML)**](../../Android/pro-lite/Utilities#get-structure-of-elements-xml) action, which you'll find in Utilities.
...
| The contents of the window after the first click on "Update":    | And after the second: |
| -------- | ------- |
| ![WebView](./assets/ElementTree/ElementTree_pic4.png)  | ![WebView](./assets/ElementTree/ElementTree_pic4-1.png)    |
...
[**Recording clicks by searching for images**](../../Settings/Record_and_InputMethods#click-recording-through-search) in the Recording tab.
:::   
_______________________________________________  
### Collapse.  
...
_______________________________________________   
### This is captcha!   
On clicking, an action [**Captcha recognition**](../../Android/pro-lite/CaptchaSolving) is created. Search parameters are picked automatically. After choosing **This is captcha!** two extra options appear.  
...
Enters the recognition result into the input field and, if **Recording** is on, adds a [**Set value**](../../Android/pro-lite/SetValue) action.  
_______________________________________________
## Useful links.  
