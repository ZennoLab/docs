...
[**Get element structure (XML)**](../../Android/ProLite/Utilities#get-ui-structure-xml) action, which you'll find in Utilities.
...
[**Recording clicks by searching for images**](../../Settings/Record_and_InputMethods#recording-clicks-using-image-search) in the Recording tab.
:::   
_______________________________________________  
### Collapse.  
