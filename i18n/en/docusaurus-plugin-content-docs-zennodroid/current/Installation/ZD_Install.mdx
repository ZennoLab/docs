---
sidebar_position: 3
sidebar_label: Installing ZennoDroid
title: Installing ZennoDroid | ZennoDroid Documentation | ZennoLab
description: Installing ZennoDroid - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---  
import DisclaimerNotice from '@site/src/components/DisclaimerNotice';

# Installing ZennoDroid
<DisclaimerNotice />
...
| ![Installation Process](./assets/ZD_Install/ZD_Install_pic10.png)     | 
| :--------: | 
...
_______________________________________________
## Useful links  
- [**System requirements**](../Installation/SysReq). 
