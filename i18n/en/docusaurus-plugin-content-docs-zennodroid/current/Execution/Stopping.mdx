...
title: «Stop» Tab | ZennoDroid Documentation | ZennoLab
description: «Stop» Tab - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
You can find it on ZennoDroid's main page — just click on the task you're interested in, then go to the **Stop** section.
...
:::tip **The *Projects Table* doesn't show the "Number of failures in a row" column by default.**
