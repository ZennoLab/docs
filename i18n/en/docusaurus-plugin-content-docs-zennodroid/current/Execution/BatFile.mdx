---
sidebar_position: 7
sidebar_label: Create a .bat File
title: Create a .bat File | ZennoDroid Documentation | ZennoLab
description: Create a .bat File - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---  
...
### Input settings  
Here, you need to specify the location on your disk where the file with the saved [**Input Settings**](../project-editor/Project/InputSetting) is located.  
_______________________________________________