...
title: Context Menu | ZennoDroid Documentation | ZennoLab
description: Context Menu - section of the official ZennoDroid documentation by ZennoLab. Detailed guides, setup instructions, and usage examples
---
...
## Menu Items.
### Settings.
This option opens the project's [**Input Settings**](../project-editor/Project/InputSetting).
...
:::info **In the [*Project Settings*](../project-editor/static-block-panel/ProjectSettings) tab, you need to set the number of threads and repetitions beforehand.**
:::
...
You can create several settings files ahead of time, and then load them with the [**Run Programs**](../project-editor/custom-code/RunningPrograms) action. Or use the [**Work with Files**](../Android/pro-lite/Files) action to dynamically create a file, save all the data you need there, and load it as necessary.
