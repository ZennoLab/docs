---
sidebar_position: 1
sidebar_label: What is CapMonster?
title: What is CapMonster? | CapMonster Documentation | ZennoLab
description: Introduction to CapMonster captcha recognition software — section of the official CapMonster documentation by ZennoLab. Detailed guides, setup instructions, and usage examples.
---
