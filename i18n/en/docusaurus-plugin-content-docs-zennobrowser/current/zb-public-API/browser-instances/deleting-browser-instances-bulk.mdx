---
sidebar_position: 5
sidebar_label: Stopping Instances (Bulk)
title: Stopping Browser Instances (Bulk)
description: Stop multiple browser instances at once - comprehensive guide for ZennoBrowser Public API. Detailed instructions, usage examples, and configuration guide
---
import DisclaimerNotice from '@site/src/components/DisclaimerNotice';

<DisclaimerNotice />

### **Stopping browser instances (bulk)**

**Description:** This method stops multiple existing browser instances associated with the specified profiles.  
