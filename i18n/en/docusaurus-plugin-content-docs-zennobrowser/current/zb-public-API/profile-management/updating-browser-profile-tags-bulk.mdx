---
sidebar_position: 17
sidebar_label: Updating Browser Profile Tags (Bulk)
title: Updating Browser Profile Tags (Bulk)
description: Updates tags for multiple browser profiles. - comprehensive guide for ZennoBrowser Public API. Detailed instructions, usage examples, and configuration guide
---
import DisclaimerNotice from '@site/src/components/DisclaimerNotice';

<DisclaimerNotice />

**Description:** This method updates the tags for one or more browser profiles at once.
