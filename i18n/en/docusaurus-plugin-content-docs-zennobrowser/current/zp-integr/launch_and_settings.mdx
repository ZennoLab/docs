---
sidebar_position: 1
sidebar_label: Launch and setup
title: Launch and setup | ZennoBrowser Documentation | ZennoLab
description: Launch and setup — section of the official ZennoBrowser documentation by ZennoLab. Detailed guides, setup instructions, and usage examples.
---
# Launch and setup
