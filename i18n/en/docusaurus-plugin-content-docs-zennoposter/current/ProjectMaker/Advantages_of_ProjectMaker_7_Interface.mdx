...
<VideoSample source={require("@site/static/video/modern_look_en.mp4").default}/>
...
![Using 2 Monitors](./assets/Advantages_of_ProjectMaker_7_Interface/Advantages_of_ProjectMaker_7_Interface_pic21.gif)

## 2.5. Smart Action Bar (Toolbox for blocks)
...
<VideoSample source={require("@site/static/video/smart_action_bar_en.mp4").default}/>
...
![Smart Action Search](./assets/Advantages_of_ProjectMaker_7_Interface/Advantages_of_ProjectMaker_7_Interface_pic22.gif)

## 2.6. Quick navigation in the project

:::warning Anyone who has worked on large projects has surely asked themselves: 
...
<VideoSample source={require("@site/static/video/quick_navigation_en.mp4").default}/>  
...
:::tip There are 2 themes — *light* and *dark*.
:::
...
:::info Window → Menu View → Customize
:::

Here you can set up any buttons on the panel, and their order—just drag and drop items with your mouse:


![Fully Personalized Toolbar](./assets/Advantages_of_ProjectMaker_7_Interface/Advantages_of_ProjectMaker_7_Interface_pic23.gif)
...
<VideoSample source={require("@site/static/video/tool_window_management_en.mp4").default}/> 

**In addition, action settings can also be in a special fifth state:**

5. Shown in the editor window.

<VideoSample source={require("@site/static/video/fifth_state.mp4").default}/>
