...
:::tip Tip
The Action bar contains the full functionality of the program—over a hundred features in total. You can find all available actions here: Actions
:::
...
<VideoSample source={require("@site/static/video/action_bar_en.mp4").default}/>
