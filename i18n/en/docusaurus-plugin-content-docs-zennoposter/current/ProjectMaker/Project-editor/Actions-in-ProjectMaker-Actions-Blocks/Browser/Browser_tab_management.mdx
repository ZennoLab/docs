...
:::info This action only works with already open windows.
...
:::info Tab numbering starts at 0.
 The first tab will always have number 0, and subsequent tabs will be 1, 2, 3, and so on.
:::
