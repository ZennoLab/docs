...
:::warning Profile folder is bound to Zennolab ID
You cannot hand a profile folder to another user: it is bound and encrypted to your Zennolab ID and works only in your ZennoPoster/ZennoBox. [Read more](../../../Recording-and-creating-projects/Using_a_Profile_Folder).
:::
