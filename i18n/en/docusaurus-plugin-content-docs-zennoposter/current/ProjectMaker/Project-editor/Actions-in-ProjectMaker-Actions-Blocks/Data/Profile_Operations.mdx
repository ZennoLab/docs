...
<VideoSample source={require("@site/static/video/profile_operations_en.mp4").default}/>
...
A saved profile folder works only under your Zennolab ID in ZennoPoster/ZennoBox. If handed to another user, it will not work.
:::
