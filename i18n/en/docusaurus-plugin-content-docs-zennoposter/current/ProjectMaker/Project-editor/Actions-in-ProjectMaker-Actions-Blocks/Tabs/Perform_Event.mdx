...
---
:::info **Please read the [*Terms of Material Use on This Resource*](../Disclaimer).**
:::
...
<u data-renderer-mark="true">Delay.</u>

1. “Wait before executing”.

How long the template will wait before setting the value.
1. “Wait for element no more than”.

If the element doesn’t appear within the specified time, the action will fail with an error.
<u data-renderer-mark="true">Emulation.</u>

1. “Default” – takes the value from project settings.
2. “Custom” – set a personal emulation level for this action (in this case, project settings will be ignored).
