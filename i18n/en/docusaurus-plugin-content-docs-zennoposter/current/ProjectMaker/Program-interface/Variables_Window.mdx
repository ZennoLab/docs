...
:::tip Quick access to renaming – double-click on the variable row in the “Name” column.

:::

:::info Renaming is available only for Custom and Global types.

:::

:::warning The variable name will also change in all actions where it is used!
...
:::info Added in ZennoPoster 7.2.1.0
