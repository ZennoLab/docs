...
A **profile folder** is an alternative way to save a profile, different from the usual method of saving to a file.

:::warning Profile folder is bound to your Zennolab ID
Profile folder data is bound and encrypted to the Zennolab ID of the account that created it.

You **cannot hand a profile folder to other users** — it **will not work** on someone else's account, even if you copy the folder to another computer.

A profile folder remains functional only in **your ZennoPoster/ZennoBox** instance, signed in under the same Zennolab ID from **your ZennoLab personal account**.
:::

It's designed to address issues such as:
...
### Binding to Zennolab ID

See the warning block at the top of this article for details. The same limitation applies to ZennoPoster and ZennoBox. Handing a profile folder to another user or trying to open it under a different Zennolab ID will not work.
