...
A profile folder remains functional only in **your ZennoPoster** instance, signed in under the same Zennolab ID from **your ZennoLab personal account**.
:::
...
See the warning block at the top of this article for details. Handing a profile folder to another user or trying to open it under a different Zennolab ID will not work.
