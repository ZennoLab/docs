...
Then click any mirror in the downloads column, and the installer file will start downloading. Once it's finished, run it and follow the further [❗→ instructions](https://zennolab.atlassian.net/wiki/spaces/RU/pages/2062483925/ZennoPoster "https://zennolab.atlassian.net/wiki/spaces/RU/pages/2062483925/ZennoPoster").
