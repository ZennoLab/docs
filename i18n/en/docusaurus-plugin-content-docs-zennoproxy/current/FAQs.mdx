...
title: Frequently Asked Questions | ZennoProxy Documentation | ZennoLab
description: Frequently Asked Questions — section of the official ZennoProxy  documentation by ZennoLab. Detailed guides, setup instructions, and usage examples.
---
...
If you can't connect to a proxy or are experiencing slow proxy speeds, change the mirror in the connection list. See more details in the *“Working with lists”* section.  

If connections are not working from **Russia**, and you have another server selected, set `Russia` in the connection list.  
