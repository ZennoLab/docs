---
sidebar_position: 2
sidebar_label: Working with Lists
title: Working with Lists | ZennoProxy Documentation | ZennoLab
description: Managing lists in ZennoProxy — section of the official ZennoProxy  documentation by ZennoLab. Detailed guides, setup instructions, and usage examples.
---
# Working with Lists
...
:::tip See also
For more on connection issues, check out the [**Frequently Asked Questions**](../FAQs#connections-arent-working-what-should-i-do) section.
:::
