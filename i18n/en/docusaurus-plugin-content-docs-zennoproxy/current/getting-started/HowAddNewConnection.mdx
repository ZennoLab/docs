---
sidebar_position: 1
sidebar_label: Adding a New Connection
title: Adding a New Connection | ZennoProxy Documentation | ZennoLab
description: How to add a new connection in the ZennoProxy interface — section of the official ZennoProxy  documentation by ZennoLab. Detailed guides, setup instructions, and usage examples.
---
...
![image4-sixty](./assets/new_connection/image4.png)  
...
![image5-sixty](./assets/new_connection/image5.png)  
...
![image6-sixty](./assets/new_connection/image6.png)  
...
![image7-fourty](./assets/new_connection/image7.png)  

For a rotating session, leave the toggle off (gray). The IP will rotate.  
![image8-fourty](./assets/new_connection/image8.png)  
...
![image9-fourty](./assets/new_connection/image9.png)  
...
![image10-fourty](./assets/new_connection/image10.png)  
